                ...
                <div className="space-y-6">
                    <div className="flex justify-between items-end border-b-[8px] border-black pb-2 drop-shadow-[4px_4px_0_#000]">
                        ...
                        <button
                            ...
                            className="sonic-button secondary text-sm py-2 px-4"
                        >
                            + NEW
                        </button>
                    </div>
                ...
                <div className="sonic-panel space-y-8 bg-[#0122e5]">
                    <div className="space-y-5">
                        ...
                        <div className="flex gap-4">
                            <div className="w-1/2 bg-white border-[6px] border-black p-4 text-2xl italic font-black text-center cursor-default shadow-[6px_6px_0_#000] transform -skew-x-6">
                                        ...
                                        {editingDeck.gameMode === GameMode.TRUTH_OR_DARE ? (
                                            <div className="flex gap-1">
                                                <button
                                                    ...
                                                    className={`px-3 py-1 italic font-black text-sm border-[3px] transition-all transform -skew-x-6 ${p.type === 'Truth' ? 'bg-[#0122e5] text-white border-black' : 'bg-white text-[#0122e5] border-black/20'}`}
                                                >
                                                    TRUTH
                                                </button>
                                                <button
                                                    onClick={() => logic.updatePromptInEditingDeck(p.id, 'type', 'Dare')}
                                                    className={`px-3 py-1 italic font-black text-sm border-[3px] transition-all transform -skew-x-6 ${p.type === 'Dare' ? 'bg-[#e10000] text-white border-black' : 'bg-white text-[#e10000] border-black/20'}`}
                                                >
                                                    DARE
                                                </button>
                                            </div>
                                        ) : (
                                            <div className="bg-black text-white px-3 py-1 italic font-black text-sm border-[3px] border-[#ffde00] transform -skew-x-6">ACT</div>
                                        )}
