...
const MinecraftApp: React.FC<{ logic: ReturnType<typeof useGameLogic> }> = ({ logic }) => {
  ...
  return (
    <div className="minecraft-theme h-[100dvh] w-screen flex flex-col bg-[#4c4c4c] text-white overflow-hidden font-['VT323']">
      <style>{`
        .minecraft-theme {
          background-image: 
      ...
      <header className="p-4 text-center shrink-0">
        <h1 className="text-4xl sm:text-5xl mc-header text-[#55FF55] uppercase">MINECRAFT: OBSIDIAN</h1>
      </header>
